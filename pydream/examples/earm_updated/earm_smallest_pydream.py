...
# exp_data = os.path.join(os.path.dirname(__file__), 'data',
...
def likelihood(position):
    ...
    logp_mbid = np.sum(like_mbid.logpdf(sim.observables['BidM_obs'] / (model.parameters['BidU_0'].value + model.parameters['BidT_0'].value + model.parameters['BidM_0'].value )))

    momp_traj = sim.observables['SmacM_obs']
