...
#     error = np.sum((data - ysim_norm) ** 2)/(0.02)
#     return -error
...
sp_p1f1 = SampledParam(norm, loc=np.log10(3.304257e-05), scale=2.0)
sp_p1f2 = SampledParam(norm, loc=np.log10(3.304257e-05), scale=2.0)
sp_p1f3 = SampledParam(norm, loc=np.log10(3.304257e-05), scale=2.0)
sampled_params_list.append(sp_p1f1)
sampled_params_list.append(sp_p1f2)
sampled_params_list.append(sp_p1f3)

sp_p1r1 = SampledParam(norm, loc=np.log10(0.009791216), scale=2.0)
sp_p1r2 = SampledParam(norm, loc=np.log10(0.009791216), scale=2.0)
sp_p1r3 = SampledParam(norm, loc=np.log10(0.009791216), scale=2.0)
sampled_params_list.append(sp_p1r1)
sampled_params_list.append(sp_p1r2)
sampled_params_list.append(sp_p1r3)

sp_p2f1 = SampledParam(norm, loc=np.log10(0.006110069), scale=2.0)
sp_p2f2 = SampledParam(norm, loc=np.log10(0.006110069), scale=2.0)
sp_p2f3 = SampledParam(norm, loc=np.log10(0.006110069), scale=2.0)
sampled_params_list.append(sp_p2f1)
sampled_params_list.append(sp_p2f2)
sampled_params_list.append(sp_p2f3)

sp_p3f1 = SampledParam(norm, loc=np.log10(4.319219e-05), scale=2.0)
sp_p3f2 = SampledParam(norm, loc=np.log10(4.319219e-05), scale=2.0)
sp_p3f3 = SampledParam(norm, loc=np.log10(4.319219e-05), scale=2.0)
sampled_params_list.append(sp_p3f1)
sampled_params_list.append(sp_p3f2)
sampled_params_list.append(sp_p3f3)

sp_p3r1 = SampledParam(norm, loc=np.log10(0.004212645), scale=2.0)
sp_p3r2 = SampledParam(norm, loc=np.log10(0.004212645), scale=2.0)
sp_p3r3 = SampledParam(norm, loc=np.log10(0.004212645), scale=2.0)
sampled_params_list.append(sp_p3r1)
sampled_params_list.append(sp_p3r2)
sampled_params_list.append(sp_p3r3)

sp_p4f1 = SampledParam(norm, loc=np.log10(1.164332e-05), scale=2.0)
sp_p4f2 = SampledParam(norm, loc=np.log10(1.164332e-05), scale=2.0)
sp_p4f3 = SampledParam(norm, loc=np.log10(1.164332e-05), scale=2.0)
sampled_params_list.append(sp_p4f1)
sampled_params_list.append(sp_p4f2)
sampled_params_list.append(sp_p4f3)
...
sampled_params_list = sampled_params_list + sampled_params_list + sampled_params_list
