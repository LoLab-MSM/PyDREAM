...
np.save('necro_pydream_5chns_929_tnf100_flipkd.npy', samples)

par_files = np.load('necro_pydream_5chns_929_tnf100_flipkd.npy')
...
result100 = solver100.run(initials= {TNF(brec=None): tnf, flip_L(bDED=None, state = 'A'): cflip}, param_values=all_pars[:24999], num_processors=20)
df = result100.dataframe
result100.save('necro_25000params_TNF10_pydream_5chns_flipkd.h5')
