...
np.save('necro_pydream_5chns_929_01tnf.npy', samples)


par_files = np.load('necro_pydream_5chns_929_01tnf.npy')
...
result100 = solver100.run(initials= {TNF(brec=None): tnf}, param_values=all_pars[:])
df = result100.dataframe
result100.save('necro_25000params_01TNF_pydream_5chns.h5')
