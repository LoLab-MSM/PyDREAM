...
def corm_setup():
    ...
    return sampled_parameter_names, likelihood, niterations, nchains

if __name__ == '__main__':

    sampled_parameter_names, likelihood, niterations, nchains = corm_setup()

    # Run DREAM sampling.  Documentation of DREAM options is in Dream.py.
    sampled_params, log_ps = run_dream(parameters=sampled_parameter_names, likelihood=likelihood, niterations=niterations, nchains=nchains,
