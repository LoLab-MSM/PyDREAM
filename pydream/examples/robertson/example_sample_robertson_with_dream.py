...
# total C trajectory at the default model parameters with a standard deviation of 0.01.
    ...
    if np.any(GR > 1.2):
        ...
        while not converged:
            ...
            sampled_params, log_ps = run_dream(sampled_parameter_names, likelihood, start=starts,
                                               ...
                                               adapt_gamma=True, history_thin=1, model_name='robertson_dreamzs_5chain',
