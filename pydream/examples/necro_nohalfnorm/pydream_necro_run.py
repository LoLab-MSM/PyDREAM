...
<<<<<<< HEAD
y100_data1 = halfnorm(loc=y100_1, scale = 0.2)
y100_data2 = norm(loc=y100_2, scale = 0.2)
y10_data1 = halfnorm(loc = y10_1, scale = 0.2)
y10_data2 = norm(loc = y10_2, scale = 0.2)

sampled_parameter_names = [SampledParam(norm, loc=par_priors, scale=3)
=======
...
sampled_parameter_names = [SampledParam(norm, loc=par_priors, scale=2)
...
<<<<<<< HEAD
                                       model_name='necro_smallest_dreamzs2620_5chainnew1', verbose=True)

    # Save sampling output (sampled parameter values and their corresponding logps).
    for chain in range(len(sampled_params)):
        np.save('necro_smallest_dreamzs_5chain_sampled_params_chain2620new1_' + str(chain)+'_'+str(total_iterations), sampled_params[chain])
        np.save('necro_smallest_dreamzs_5chain_logps_chain2620new1_' + str(chain)+'_'+str(total_iterations), log_ps[chain])
=======
                                       model_name='necro_smallest_dreamzs2620_5chainnew', verbose=True)

    # Save sampling output (sampled parameter values and their corresponding logps).
    for chain in range(len(sampled_params)):
        np.save('necro_smallest_dreamzs_5chain_sampled_params_chain2620new_' + str(chain)+'_'+str(total_iterations), sampled_params[chain])
        np.save('necro_smallest_dreamzs_5chain_logps_chain2620new_' + str(chain)+'_'+str(total_iterations), log_ps[chain])
>>>>>>> 51046d548cb8adb85160225788e427e1d4dea85b
...
<<<<<<< HEAD
    np.savetxt('necro_smallest_dreamzs_5chain2620_GelmanRubin_iterationnew1_'+str(total_iterations)+'.txt', GR)
=======
    np.savetxt('necro_smallest_dreamzs_5chain2620_GelmanRubin_iterationnew_'+str(total_iterations)+'.txt', GR)
>>>>>>> 51046d548cb8adb85160225788e427e1d4dea85b
...
<<<<<<< HEAD
                                               adapt_gamma=True, history_thin=1, model_name='necro_smallest_dreamzs2620_5chainnew1',
=======
...
>>>>>>> 51046d548cb8adb85160225788e427e1d4dea85b
            ...
            for chain in range(len(sampled_params)):
<<<<<<< HEAD
                np.save('necro_smallest_dreamzs2620_5chain_sampled_params_chainnew1_' + str(chain)+'_'+str(total_iterations), sampled_params[chain])
                np.save('necro_smallest_dreamzs2620_5chain_logps_chainnew1_' + str(chain)+'_'+str(total_iterations), log_ps[chain])
=======
                np.save('necro_smallest_dreamzs2620_5chain_sampled_params_chainnew_' + str(chain)+'_'+str(total_iterations), sampled_params[chain])
                np.save('necro_smallest_dreamzs2620_5chain_logps_chainnew_' + str(chain)+'_'+str(total_iterations), log_ps[chain])
>>>>>>> 51046d548cb8adb85160225788e427e1d4dea85b
            ...
            print('At iteration: ',total_iterations,' GR = ',GR)
<<<<<<< HEAD
            np.savetxt('necro_smallest_dreamzs2620_5chain_GelmanRubin_iterationnew1_' + str(total_iterations)+'.txt', GR)
=======
            np.savetxt('necro_smallest_dreamzs2620_5chain_GelmanRubin_iterationnew_' + str(total_iterations)+'.txt', GR)
>>>>>>> 51046d548cb8adb85160225788e427e1d4dea85b
...
<<<<<<< HEAD
            fig.savefig('PyDREAM_necro2620_smallest_dimensionnew1_'+str(dim))
=======
            fig.savefig('PyDREAM_necro2620_smallest_dimensionnew_'+str(dim))
>>>>>>> 51046d548cb8adb85160225788e427e1d4dea85b
...
<<<<<<< HEAD
                  'multitry':False, 'gamma_levels':4, 'adapt_gamma':True, 'history_thin':1, 'model_name':'necro_smallest_dreamzs2620_5chainnew1', 'verbose':False}
=======
                  'multitry':False, 'gamma_levels':4, 'adapt_gamma':True, 'history_thin':1, 'model_name':'necro_smallest_dreamzs2620_5chainnew', 'verbose':False}
>>>>>>> 51046d548cb8adb85160225788e427e1d4dea85b
